 ...
 * Original file: D:\\Projects\\Android\\TrivialDrive\\TrivialDrive\\src\\com\\android\\vending\\billing\\IInAppBillingService.aidl
 */
 ...
 *    after it completes.
 * 3. Purchase information of in-app purchases is maintained within the Bazaar system
...
public static abstract class Stub extends android.os.Binder implements IInAppBillingService
{
 ...
 */
public static IInAppBillingService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
...
/**
     ...
     */
@Override public int isBillingSupported(int apiVersion, String packageName, String type) throws android.os.RemoteException
{
...
/**
     ...
     */
@Override public android.os.Bundle getSkuDetails(int apiVersion, String packageName, String type, android.os.Bundle skusBundle) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     */
@Override public android.os.Bundle getBuyIntent(int apiVersion, String packageName, String sku, String type, String developerPayload) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Bundle _result;
...
/**
     ...
     */
@Override public android.os.Bundle getPurchases(int apiVersion, String packageName, String type, String continuationToken) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Bundle _result;
...
/**
     ...
     */
@Override public int consumePurchase(int apiVersion, String packageName, String purchaseToken) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
